    ...
    <HomeLayout>
      <div className="flex flex-col gap-10 items-center justify-center min-h-[90vh] py-10 text-white mx-[5%]">
        ...
        (<div className="flex justify-center gap-10 w-full">
          ...
          {/* {right section for displaying list} */}

          <ul className="w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black] space-y-5">
            <p>Lecture list</p>

          
            <li className="font-semibold text-xl text-yellow-500 flex items-center justify-between"></li>
                ...
                <li className="space-y-2" key={lecture._id}>
                  ...
                  {role === "ADMIN" && (
                    <button
                      ...
                      className="btn-accent px-2 py-1 rounded-md font-semibold text-sm bg-lime-300"
                    >
                      Delete lecture
                    </button>
                  )}
          ...
          <button
            ...
            className="btn-primary px-2 py-1 rounded-md font-semibold text-sm bg-yellow-600 "
          >
            Add new lecture
          </button>
        )}
